...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            Image img = Image.getInstance("src/imagenes/pelota-de-futbol.png");
            ...
            String nombre = "La Canchita POO";
            String telefono = "0963088564";
            String direccion = "Escuela Politecnica Nacional";
            String razon = "Todo sea por salvar el semestre :p";
